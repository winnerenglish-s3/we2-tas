<template>
  <div :style="screenWidth >= 1200 ? '' : 'min-width: 320px'">
    <div
    ...
    <div v-else class="q-py-md text-center f16-m">
      What Is This / That? It Is a ______.
    </div>
    <!-- เนื้อหา -->
    <div align="center" :class="screenWidth > 1024 ? 'q-px-md' : ''">
